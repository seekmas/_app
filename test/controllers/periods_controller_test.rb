...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { chapter_id: @period.chapter_id, content: @period.content, cover: @period.cover, quiz: @period.quiz, reference: @period.reference, subject: @period.subject }
    end
  ...
  test "should update period" do
    patch :update, id: @period, period: { chapter_id: @period.chapter_id, content: @period.content, cover: @period.cover, quiz: @period.quiz, reference: @period.reference, subject: @period.subject }
    assert_redirected_to period_path(assigns(:period))
  end
