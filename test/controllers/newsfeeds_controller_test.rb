...
class NewsfeedsControllerTest < ActionController::TestCase
  ...
  test "should create newsfeed" do
    assert_difference('Newsfeed.count') do
      post :create, newsfeed: { content: @newsfeed.content, enabled: @newsfeed.enabled, order_id: @newsfeed.order_id, subject: @newsfeed.subject }
    end
  ...
  test "should update newsfeed" do
    patch :update, id: @newsfeed, newsfeed: { content: @newsfeed.content, enabled: @newsfeed.enabled, order_id: @newsfeed.order_id, subject: @newsfeed.subject }
    assert_redirected_to newsfeed_path(assigns(:newsfeed))
  end
