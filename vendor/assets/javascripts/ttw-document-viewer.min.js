...
(function (a) {
    ...
    a.fn.imagesLoaded = function (e) {
        var c = this.filter("img"), b = c.length, d = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";
    ...
    var b = function (d) {
        ...
        function h(k) {
            ...
            if (e[j.dependency]()) {
                ...
                yepnope({
                    load: f[j.dependency], complete: function () {
                        if (e[j.dependency]()) {
        ...
        return {loadDependency: h}
    };
    var a = function (p, u) {
        var s, F, k, r = ["bsh", "c", "cc", "cpp", "cs", "csh", "css", "cyc", "cv", "htm", "html", "java", "js", "m", "mxml", "perl", "php", "pl", "pm", "py", "rb", "sh", "xhtml", "xml", "xsl", "sql", "vb"], D = ["png", "jpg", "jpeg", "gif"], e = ["mp3", "m4a", "oga", "webma", "fla"], w = ["m4v", "ogv", "ogg", "webmv", "flv"], j = ["mpg", "mpeg", "mov", "divx", "avi", "wmv"], S = w.concat(j), y = w.concat(e), M = {
            width: 500,
            height: "auto",
            debug: false,
            autoplay: true,
        ...
        function N() {
            ...
            k.html(A.emptyText);
            H(A);
            l = new b({path: A.path, errorHandler: v})
        }
        ...
        function q(T, U) {
            if (!A.autoLoadDependencies) {
                ...
                l.loadDependency({dependency: T, callback: U})
            }
        }
        ...
        var B = function (U, ab) {
            var X, Z = 1, T = c('<div class="pdf-menu"><div class="prev-page" >上一页</div><div class="next-page">下一页</div><div class="go-to-page">跳转到 <input></div></div>');
            ...
            return {load: aa, setPage: Y}
        };
        var h = function (T, U) {
            c.ajax({
                url: U.path + "libs/getContents.php", type: "POST", data: {file: T}, success: function (V) {
                    V = c.parseJSON(V);
                    if (V.status === "success") {
        ...
        var Q = function (U, ab) {
            ...
            X = {
                ...
                size: {height: ab.height, width: ab.width, cssClass: "show-video"},
                sizeFull: {width: "100%", height: "90%", cssClass: "show-video-full"}
            };
            function Y() {
                var ac, ae, ad;
                ...
                ae = c(ac).css({opacity: 0}).appendTo(k);
                ad = k.width();
                Z.size.width = ad;
        ...
        N();
        return {load: K, close: L, getDocumentType: n}
    };
